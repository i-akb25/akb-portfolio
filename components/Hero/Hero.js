    ...
    >
      ...
      <div className="flex flex-col pt-40 md:pt-0 select-none">
        ...
        <h1 className={`${styles.heroName} text-white text-6xl font-semibold`}>
          ...
          <span className="staggered-reveal text-indigo-dark"> ARYAN</span>
        </h1>
        <p>
          <span
            ref={typedElementRef}
        ...
        <div className="staggered-reveal pt-4">
          ...
          <Button href="https://drive.google.com/drive/folders/1A2apkM1qe_Cn8mfP3YFJQtC90hbaHK86" classes="link" type="primary" style={{ marginLeft: '20px' }}>
           Resume
          </Button>
        </div>
      </div>
