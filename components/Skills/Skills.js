      ...
      <div className="section-container py-16 flex flex-col justify-center">
        ...
        <div className="flex flex-col skills-wrapper">
          <div className="flex flex-col">
            ...
            I enjoy building seamless and engaging user experiences with modern full-stack development 
            and apply my electrical engineering skills to innovative solutions.{" "}
            </h2>
          </div>
          <div className="mt-10">
